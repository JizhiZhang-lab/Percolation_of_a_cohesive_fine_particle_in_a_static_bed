...
% plot([x_min x_max], [0.12 0.12], 'r-.', 'LineWidth', 1);    % y = 0.12
...
h = annotation('doublearrow', [0.355 0.355], [0.53 0.87]);
...
text(-0.012,0.093,'$3\lambda$','color',colors(5,:),'fontsize',16,'Interpreter','latex');

% Print at high resolution
% print(gcf, 'distribution_000_120.jpg', '-djpeg', '-r300');
exportgraphics(gcf, 'distribution_Bo_24_001.jpg', 'Resolution', 300, 'BackgroundColor', 'none');
