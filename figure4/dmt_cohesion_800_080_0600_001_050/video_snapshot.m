...
text(-0.006,0.138,'$z$','color','k','fontsize',12,'Interpreter','latex');
text(0.01,0.132,'$x$','color','k','fontsize',12,'Interpreter','latex');

annotation('arrow', [0.365 0.415], [0.925 0.925], 'LineWidth', 1, 'HeadLength', 4, 'HeadWidth', 4, 'Color', 'k');
annotation('arrow', [0.365 0.365], [0.925 0.98], 'LineWidth', 1, 'HeadLength', 4, 'HeadWidth', 4, 'Color', 'k');

% annotation('arrow', [0.365 0.365], [0.98 0.98], 'LineWidth', 1, 'HeadLength', 4, 'HeadWidth', 4, 'Color', 'k');
annotation('ellipse', [0.29 1 0.0001 0.0001], ...
    'Color', 'k', 'FaceColor', 'k');

text(-0.006,0.128,'$0$','color','k','fontsize',12,'Interpreter','latex');

text(-0.016,0.001,'$-32d_l$','color','k','fontsize',12,'Interpreter','latex');


exportgraphics(gcf, 'distribution_Bo_8_001.jpg', 'Resolution', 300, 'BackgroundColor', 'none');
