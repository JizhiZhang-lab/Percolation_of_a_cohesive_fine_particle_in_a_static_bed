...
text(-0.006,0.138,'$z$','color','w','fontsize',12,'Interpreter','latex');
text(0.01,0.132,'$x$','color','w','fontsize',12,'Interpreter','latex');

% annotation('arrow', [0.365 0.415], [0.925 0.925], 'LineWidth', 1, 'HeadLength', 4, 'HeadWidth', 4, 'Color', 'w');
% annotation('arrow', [0.365 0.365], [0.925 0.98], 'LineWidth', 1, 'HeadLength', 4, 'HeadWidth', 4, 'Color', 'w');
% 
% annotation('arrow', [0.365 0.365], [0.98 0.98], 'LineWidth', 1, 'HeadLength', 4, 'HeadWidth', 4, 'Color', 'k');

annotation('ellipse', [0.338 1 0.0001 0.0001], ...
    'Color', 'k', 'FaceColor', 'k');


% Print at high resolution
% print(gcf, 'distribution_000_120.jpg', '-djpeg', '-r300');
exportgraphics(gcf, 'distribution_000_050_120.jpg', 'Resolution', 300, 'BackgroundColor', 'none');
